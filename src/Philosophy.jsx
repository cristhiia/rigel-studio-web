...
export default function Philosophy() {
  return (
    <section className="bg-transparent py-8 md:py-32 px-6 flex justify-center border-t border-[#856612]/10 relative z-10 w-full min-h-[80vh]">
      <motion.div 
      ...
      >
        ...
        {/* Cuerpo de la Carta */}
        <article className="font-serif text-[#4a4540] text-[1.1rem] md:text-xl leading-[1.7] md:leading-[1.8] space-y-6 md:space-y-8 italic opacity-90">
          <p>
